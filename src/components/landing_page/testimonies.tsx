  ...
  return (
      <section className='px-6 md:px-24 text-white py-10 mt-10 bg-gray-2'>
          <div className="flex flex-col items-center justify-center">
              ...
              <h6 className='text-[14px] font-medium my-3 text-center w-[70%] lg:w-[65%]'>We have a reputation for helping companies and individuals around the world build wining teams and launch dream careers.</h6>
          </div>
